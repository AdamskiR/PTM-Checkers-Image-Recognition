...
public class ReadColorWhite : MonoBehaviour
{
    [SerializeField] string imagePath = "/CameraPictures/CameraInput.png";

    [Header("RGB Colors")]
    [SerializeField] [Range(0, 1)] float Rvalue = 0.4f;
    [SerializeField] [Range(0, 1)] float Gvalue = 0.4f;
    [SerializeField] [Range(0, 1)] float Bvalue = 0.4f;
