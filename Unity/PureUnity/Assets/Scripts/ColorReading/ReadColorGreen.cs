...
public class ReadColorGreen : MonoBehaviour
{
    [SerializeField] string imagePath = "/CameraPictures/CameraInput.png";

    [Header("RGB Colors")]
    [SerializeField] [Range(0, 1)] float Rvalue = 0.3f;
    [SerializeField] [Range(0, 1)] float Gvalue = 0.6f;
    [SerializeField] [Range(0, 1)] float Bvalue = 0.3f;

    [Header("Picture details")]
    [SerializeField][Range(0,100)] int ObjectsDetectionRange = 50;
