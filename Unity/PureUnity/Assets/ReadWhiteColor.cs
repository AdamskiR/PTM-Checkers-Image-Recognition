...
public class ReadWhiteColor: MonoBehaviour
{
    ...
    public void ReadColors()
    {
        ...
        if (File.Exists(Application.dataPath + imagePath))
        {
            ...
            File.WriteAllBytes(Application.dataPath + "/CameraPictures/CameraInputMap1.png", Bytes);
            ...
            File.WriteAllBytes(Application.dataPath + "/CameraPictures/CameraInputChecker.png", Bytes1);
            */
        }
    }
